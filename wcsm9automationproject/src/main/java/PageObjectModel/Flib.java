...
public class Flib {
	public static String readDataFromExcel(String excelPath,String sheetName,int rowCount,int cellCount) throws EncryptedDocumentException, IOException
	{
	...
	public static String readDataFromProperty(String propPath,String Key) throws IOException
	{
